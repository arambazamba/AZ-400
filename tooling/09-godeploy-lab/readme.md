...
- You can access the lab environment using [https://lms.godeploy.it/](https://lms.godeploy.it/) and the GoDeploy Lab Key provided to you
- Add a new lab using your lab key
- Start the lab
